...
Sinonimia es una aplicación web completamente del lado del cliente: no
...
Solo la rama `main` recibe parches de seguridad. No mantenemos
versiones antiguas.

## Cómo reportar una vulnerabilidad

Abre un aviso privado a través de
[GitHub Security Advisories](https://github.com/miralante/sinonimia/security/advisories/new).
