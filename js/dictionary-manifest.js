...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=6279740dc2" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=fd481ef000" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=e278ae8c9f" },
  ],
};
