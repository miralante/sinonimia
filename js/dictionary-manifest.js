...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=0df151e4b4" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=f2fafbb844" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=6dfdbdccee" },
    { file: "js/data.en.2.js", src: "js/data.en.2.js?v=a88283f0b4" },
  ],
};
