...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=55b7eaa71e" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=280c8f2b45" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=a3fda25d30" },
  ],
};
