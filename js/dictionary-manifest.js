...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=ddd216111f" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=075b9861e4" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=61f8de2282" },
  ],
};
