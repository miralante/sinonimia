...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=dedbb22fda" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=382c00fc8e" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=20b7ce233c" },
  ],
};
