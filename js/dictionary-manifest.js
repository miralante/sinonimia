...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=424aa2b601" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=215de7f78f" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=6dfdbdccee" },
    { file: "js/data.en.2.js", src: "js/data.en.2.js?v=750e27c4b3" },
  ],
};
