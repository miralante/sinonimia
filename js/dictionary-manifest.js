...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=4f0242ceb2" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=6ec6bee34d" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=a66b2362a7" },
  ],
};
