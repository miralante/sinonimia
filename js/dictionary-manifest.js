...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=1fa1b5b7b1" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=dec5f4df2c" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=f831fa41c2" },
  ],
};
