...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=0b50e67d2f" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=97489667e0" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=310ab855ea" },
  ],
};
