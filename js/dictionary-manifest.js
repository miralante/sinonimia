...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=b14e0225ac" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=f3092becae" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=ec4fa25c36" },
  ],
};
