...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=fd28f2500d" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=b2faeeaf56" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=40df85130b" },
  ],
};
