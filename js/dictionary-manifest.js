...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=4083a21f51" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=c4e5859fac" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=a0a570eb68" },
  ],
};
