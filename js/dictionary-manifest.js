...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=edc3ae1ec9" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=f588180337" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=04907c64e2" },
  ],
};
