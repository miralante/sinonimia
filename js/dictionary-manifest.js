...
window.SINONIMIA_DICTIONARY_SHARDS = {
  es: [
    { file: "js/data.es.js", src: "js/data.es.js?v=ce9568fcc2" },
    { file: "js/data.es.2.js", src: "js/data.es.2.js?v=d8a80fb953" },
  ],
  en: [
    { file: "js/data.en.js", src: "js/data.en.js?v=fae9de63da" },
  ],
};
